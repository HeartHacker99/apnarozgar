...
@section('content')
    <div class="panel panel-danger">
        <div class="panel-body">
            ...
            <form class="form-horizontal" action="{{ url('/gigs_store') }}" method="Post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                    <label for="title" class="col-sm-2 control-label" >GIG TITLE</label>
                    <div class="col-sm-10">
                        <textarea rows="3" id="title" class="form-control" name="title" required>{{$title}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea rows="5" class="form-control"  name="description" required>{{$description}}</textarea>
                    </div>
                </div>
                <div class="form-group">
