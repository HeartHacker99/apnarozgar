...
<x-jet-form-section submit="freelancer Details">
    <x-slot name="title">
        {{ __('Additional Details') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Add Your Skills and Additional information ') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="w-md-75">
            ...
            <div class="form-group">
                ...
                <x-jet-input id="education" type="text" class="{{ $errors->has('education') ? 'is-invalid' : '' }}" wire:model.defer="state.name" autocomplete="education" />
                <x-jet-input-error for="education" />
            </div>
            <!-- Email -->
            <div class="form-group">
                <x-jet-label for="skills" value="{{ __('Skills') }}" />
                <x-jet-input id="skills" type="text" class="{{ $errors->has('skills') ? 'is-invalid' : '' }}" wire:model.defer="state.skills" />
