            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    @if($user->block_status == 1)
                        <a href="{{url('admin/user_status/0')}}/{{$user->id}}" id="gig_space" >  <button type="button" class="btn btn-primary">Activate Account</button>  </a>
                    @elseif($user->block_status == 0)
                        <a href="{{url('admin/user_status/1')}}/{{$user->id}}" id="gig_space">  <button type="button" class="btn btn-secondary">Deactivate Account</button>  </a>
                    @endif
                </td>
            </tr>
        @endforeach
