...
class CheckoutController extends Controller
{
	...
	public function DoCheckout(Request $request)
	{
       ...
       /* $temp_amount = $data['price'];
        $amount_array 	= explode('.', $temp_amount);*/
        $pp_name        = $data['fullname'];
        $pp_Amount 		= $data['price'];
		//NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
		...
		$post_data =  array(
			...
			"pp_Description" 		=> "Description of transection",
        ...
        $values = new orders();
        $values->TxnRefNo=$post_data['pp_TxnRefNo'];
        $values->amount=$pp_Amount;
        $values->name=$pp_name;
		...
		return view('payment.do_checkout_v');
	...
	public function paymentStatus(Request $request)
	{
		...
		return view('payment.payment-status',['response'=>$response]);
	}
